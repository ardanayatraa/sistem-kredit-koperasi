    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
        <div class="flex items-center justify-between">
            ...
            <div class="p-2 bg-green-50 rounded-lg flex-shrink-0">
                <i class="bx bx-user-plus text-green-600 h-6 w-6"></i>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
        <div class="flex items-center justify-between">
            ...
            <div class="p-2 bg-purple-50 rounded-lg flex-shrink-0">
                <i class="bx bx-user-check text-purple-600 h-6 w-6"></i>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
        <div class="flex items-center justify-between">
            ...
            <div class="p-2 bg-orange-50 rounded-lg flex-shrink-0">
                <i class="bx bx-chart-line text-orange-600 h-6 w-6"></i>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="overflow-x-auto">
        <?php if (empty($anggota)): ?>
            <div class="px-4 sm:px-6 py-12 text-center">
                <i class="bx bx-users mx-auto h-12 w-12 text-gray-400"></i>
