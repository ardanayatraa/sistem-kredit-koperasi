                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-4">
                             ...
                             <div id="existing-preview-agunan" class="mt-3">
                                 <div class="border-2 border-dashed border-blue-300 rounded-lg p-4 bg-blue-50">
                                     <div class="text-center">
                                         <div class="relative inline-block">
                                             <img src="/kredit/view-document/<?= esc($kredit['dokumen_agunan']) ?>" alt="Existing Preview" class="max-w-full max-h-64 mx-auto rounded-lg shadow-sm border border-blue-200" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
